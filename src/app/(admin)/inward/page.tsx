                ...
                <tbody>
                  {paginatedInwards.map((item, index) => (
                    <tr key={item.id} className="border-bottom border-light">
                      ...
                      <td>
                        <Link href={`/inward/${item.id}`} className="fw-900 text-dark fs-6 mb-0 text-decoration-none hover-underline d-block" style={{ cursor: 'pointer' }}>
                      ...
                      <td className="text-center px-4">
                        <div className="d-flex justify-content-center align-items-center gap-1">
                          <Link href={`/inward/${item.id}`} className="btn-action-view" title="View Detail"><i className="bi bi-eye-fill"></i></Link>
                          {mounted && checkActionPermission(user, 'mod_inward', 'edit') && (
                            <Link href={`/inward/${item.id}?edit=true`} className="btn-action-edit" title="Edit Inward"><i className="bi bi-pencil-fill"></i></Link>
                          )}
