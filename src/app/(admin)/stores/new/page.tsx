    ...
    <ModuleGuard moduleId="mod_lead">
      <div className="bg-white min-vh-100 p-4 animate-fade-in shadow-sm">
        <div className="mb-4 d-flex align-items-center gap-3 border-bottom pb-3">
          <Link href="/stores" className="btn btn-outline-secondary border-0 p-0 me-2" title="Back to Stores">
            <i className="bi bi-arrow-left-circle fs-3 text-muted"></i>
          </Link>
          <div>
            <h4 className="fw-800 tracking-tight text-dark mb-0">Add New Field Store</h4>
